...
public class SectionIndexBuilder {
    ...
    public static Object[] BuildSectionHeaders(Curso[] clientes)
    {
        ArrayList<String> results = new ArrayList<>();
        TreeSet<String> used    = new TreeSet<>();
        if(clientes != null) {
            for (Curso item : clientes) {
    ...
    public static Hashtable<Integer, Integer> BuildSectionForPositionMap(Curso[] clientes)
    {
    ...
    public static Hashtable<Integer, Integer> BuildPositionForSectionMap(Curso[] clientes)
    {
        Hashtable results = new Hashtable<Integer, Integer>();
        TreeSet<String> used    = new TreeSet<>();
        int section = -1;
